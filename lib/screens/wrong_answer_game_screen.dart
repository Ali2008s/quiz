...
class _WrongAnswerGameScreenState extends State<WrongAnswerGameScreen> with TickerProviderStateMixin {
  ...
  void _onWheelStop() {
    ...
    setState(() {
      ...
      _currentQuestion = GameData.questions['جاوب خطأ']![_random.nextInt(GameData.questions['جاوب خطأ']!.length)];
  ...
  Widget _buildWheelState() {
    return Column(
      children: [
              ...
              builder: (context, child) {
                return Transform.rotate(
                  ...
                  child: CustomPaint(
                    ...
                    painter: WrongAnswerWheelPainter(players: widget.players),
                  ),
                );
              },
            ),
        ...
        StyledNextButton(
          text: 'عرض النتيجة',
          onTap: () => setState(() => _state = GameState.results),
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color(0xFFEF9A9A), width: 4),
          ),
          child: Text(
            _currentQuestion,
        ...
        Row(
          ...
          children: [
            _actionBtn(Icons.close, const Color(0xFFEF9A9A), () {
              // Failed to answer wrongly
              setState(() => _state = GameState.wheel);
            }),
            const SizedBox(width: 40),
            _actionBtn(Icons.check, const Color(0xFFA5D6A7), () {
              // Successfully answered wrongly
      ...
      children: [
        ...
        ...sortedPlayers.map((p) => Container(
          ...
          child: Row(
            ...
            children: [
              Text(p, style: GoogleFonts.lalezar(fontSize: 22)),
              Text('${_scores[p]} نقطة', style: GoogleFonts.lalezar(fontSize: 22)),
            ],
          ),
        )).toList(),
        const SizedBox(height: 40),
