...
class AIService {
  ...
  static Future<String?> getWhoIsQuestion() => 
    getAIResponse('اعطني سؤال يبدأ بـ "من هو أكثر شخص..." للعبة (من هو؟) باللهجة العراقية، مثلا من اكثر شخص ممكن يضيع بالسوك؟ مع كتابة السؤال فقط دون اضافة اي نص اخر', 'من هو');

  static Future<String?> getProverb() => 
    getAIResponse('اعطني مثل شعبي عراقي وافصل نصه الأول عن نصه الثاني بعلامة | للكتابة فقط دون اي كلام اضافي. مثال: الما يعرف يركص | يكول الكاع عوجة', 'كمل المثل');
}
